...
async function start() {
  // تجربة 1: تمرير quote_items ككائن مفاتيح رقمية ( associative object)
  await runTest(
    "1. quote_items as object with numeric keys",
    {
      "quote": {
        "client_id": 2082,
  ...
  // تجربة 2: تمرير items ككائن مفاتيح رقمية
  await runTest(
    "2. items as object with numeric keys",
    {
      "quote": {
        "client_id": 2082,
        "quote_date_created": "2026-06-04",

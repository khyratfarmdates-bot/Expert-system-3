...
async function start() {
  const itemsArray = [
    {
      "item_name": "Test Item Flat",
      "item_price": 50,
      "item_quantity": 2
    }
  ];

  // تجربة 1: تمرير quote_items بجانب quote
  await runTest(
    "1. quote_items alongside quote",
    {
      "quote": {
        "client_id": 2082,
        "quote_date_created": "2026-06-04"
      },
      "quote_items": itemsArray
    }
  );

  // تجربة 2: تمرير items بجانب quote
  await runTest(
    "2. items alongside quote",
    {
      "quote": {
        "client_id": 2082,
        "quote_date_created": "2026-06-04"
